...
proc create_root_design { parentCell } {
  ...
  # Create instance: image_inverter_0, and set properties
  set image_inverter_0 [ create_bd_cell -type ip -vlnv sase2015:sase2015:image_inverter:1.0 image_inverter_0 ]
  set_property -dict [ list CONFIG.C_M_AXI_MEM_DATA_WIDTH {64}  ] $image_inverter_0
  ...
  connect_bd_intf_net -intf_net image_inverter_0_m_axi_mem [get_bd_intf_pins axi_mem_intercon/S01_AXI] [get_bd_intf_pins image_inverter_0/m_axi_mem]
  ...
  connect_bd_intf_net -intf_net processing_system7_0_axi_periph_M02_AXI [get_bd_intf_pins image_inverter_0/s_axi_AXILiteS] [get_bd_intf_pins processing_system7_0_axi_periph/M02_AXI]
  ...
  connect_bd_net -net rst_processing_system7_0_100M_peripheral_aresetn [get_bd_pins axi_dispctrl_0/s_axi_aresetn] [get_bd_pins axi_mem_intercon/M00_ARESETN] [get_bd_pins axi_mem_intercon/S00_ARESETN] [get_bd_pins axi_mem_intercon/S01_ARESETN] [get_bd_pins axi_vdma_0/axi_resetn] [get_bd_pins image_inverter_0/ap_rst_n] [get_bd_pins processing_system7_0_axi_periph/M00_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M01_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M02_ARESETN] [get_bd_pins processing_system7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_processing_system7_0_100M/peripheral_aresetn]
  ...
  create_bd_addr_seg -range 0x20000000 -offset 0x0 [get_bd_addr_spaces image_inverter_0/Data] [get_bd_addr_segs processing_system7_0/S_AXI_HP0/HP0_DDR_LOWOCM] SEG_processing_system7_0_HP0_DDR_LOWOCM
  ...
  create_bd_addr_seg -range 0x10000 -offset 0x43C10000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs image_inverter_0/s_axi_AXILiteS/Reg] SEG_image_inverter_0_Reg
